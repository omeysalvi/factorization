...
best_idx = 499597
theta = best_idx * theta_step
r_value = int(math.sqrt(2 * semiprime / math.sin(2 * theta)))
base_num = int(r_value * math.cos(theta))

print('Target prime:', prime1)
print('Base num:', base_num)
print('Diff:', abs(base_num - prime1))

base_nums = np.array([base_num], dtype=np.uint64)
...
print('Found factor:', found_factor_arr[0])
